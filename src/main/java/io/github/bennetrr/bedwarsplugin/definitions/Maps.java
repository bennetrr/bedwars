...
public class Maps {
    public static BPMap getMap(World w, Location mapPasteLoc, BedwarsPlugin plugin) {
        ...
        teamTemplates.add(new BPTeamTemplate(NamedTextColor.GRAY, "teamGray", "Team Cave", new Location(w, 40, 41, 0), new Location(w, 49, 41, -5, 0, 0), new Location(w, 49, 41, 5, 180, 0), new Location(w, 54, 41, 0), new Location(w, 49, 41, 0, 90, 0), new Location(w, 35, 36, -8), new Location(w, 58, 49, 8)));
        ...
        teamTemplates.add(new BPTeamTemplate(NamedTextColor.GOLD, "teamOrange", "Team Desert", new Location(w, 0, 41, 42), new Location(w, -4, 41, 53, -135, 0), new Location(w, 4, 41, 53, 135, 0), new Location(w, 0, 41, 55), new Location(w, 0, 41, 49, 0, 0), new Location(w, -8, 36, 37), new Location(w, 8, 49, 60)));
